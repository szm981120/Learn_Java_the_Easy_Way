...
public class BubbleDrawGUI extends JFrame {
	...
	/* 这是我们BubbleDrawGUI的主程序，而非BubblePanel，虽然大多数工作都是在BubblePanel中做的 */
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		JFrame frame = new JFrame("Shen Ziming's BubbleDraw GUI App");	// 实例化一个包含标题栏的JFrame对象
		...
		frame.setSize(new java.awt.Dimension(1024,768));	// 设置窗口尺寸
